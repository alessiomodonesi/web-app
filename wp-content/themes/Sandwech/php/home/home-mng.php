...
<div class="main-container">
  <div class="cards text-center">
    ...
    <div class="card card-1" onclick="location.href='http://localhost/sandwech/break';" style="cursor: pointer;">
      ...
      <h2 id="h2-cards" class="card__title">Break</h2>
      <p class="card__apply">
        <a class="card__link">Gestione intervalli<i class="fas fa-arrow-right"></i></a>
      </p>
    </div>
    ...
    <div class="card card-1" onclick="location.href='http://localhost/sandwech/class';" style="cursor: pointer;">
      ...
      <p class="card__apply">
        <a class="card__link">Gestione classi<i class="fas fa-arrow-right"></i></a>
      </p>
    </div>
    ...
    <div class="card card-1" onclick="location.href='http://localhost/sandwech/reset';" style="cursor: pointer;">
      ...
      <p class="card__apply">
        <a class="card__link">Gestione reset password<i class="fas fa-arrow-right"></i></a>
      </p>
    </div>
    ...
    <div class="card card-1" onclick="location.href='http://localhost/sandwech/pickup';" style="cursor: pointer;">
      ...
      <p class="card__apply">
        <a class="card__link">Gestione punti di ritiro<i class="fas fa-arrow-right"></i></a>
      </p>
    </div>
    ...
    <div class="card card-1" onclick="location.href='http://localhost/sandwech/status';" style="cursor: pointer;">
      ...
      <p class="card__apply">
        <a class="card__link">Gestione stato dell'ordine<i class="fas fa-arrow-right"></i></a>
      </p>
    </div>
    ...
    <div class="card card-1" onclick="location.href='http://localhost/sandwech/user';" style="cursor: pointer;">
      <div class="card__icon"><i class="fas fa-bolt"></i></div>
      <p class="card__exit"><i class="fas fa-times"></i></p>
      <h2 class="card__title">User</h2>
      <p class="card__apply">
        <a class="card__link">Gestione utenti<i class="fas fa-arrow-right"></i></a>
      </p>
    </div>
